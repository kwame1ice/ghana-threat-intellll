...
phone = input("Enter phone number (e.g., +233...): ")
...
# Convert session file to Base64
...
print("\n⚠️ Copy the text from 'ghana_session_b64.txt' and add it to your GitHub secret TELEGRAM_SESSION_B64.")
